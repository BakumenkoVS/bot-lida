      ...
      switch (ctx.data) {
         ...
         case "contraindications":
            await bot.sendPhoto(ctx.message.chat.id, "./img/3.jpg", {
               caption:
                  "<b>Противопоказания\n• Выраженная гипертония\n• ЛОР-заболевания\n• ОРВИ\n• Беременность\n• Артриты (стадии обострения)\n• Артрозы 3-4 степени\n• Спондилолистез\n• Остеопороз\n• Острые состояния, связанные с заболеванием внутренних органов\n\n❗️Можно девушкам на грудном вскармливании и про диастазе 1 степени (расстояние между внутренними краями прямых мышц живота от 4 до 7 см)</b>",
               parse_mode: "HTML",
               reply_markup: {
                  inline_keyboard: [
                     [
