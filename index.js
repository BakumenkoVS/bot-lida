      ...
      if (msg.text == "/start") {
         ...
         setTimeout(async () => {
            await bot.sendMessage(
               msg.chat.id,
               "ты присоединилась к интенсиву?\n\nесли нет, то сейчас - самое время, старт проекта уже в эту среду)",
               {
                  reply_markup: {
                     inline_keyboard: [
                        [
         ...
         setTimeout(async () => {
            await bot.sendMessage(
               msg.chat.id,
               "осталось 10 мест на интенсив\nзапись закрывается сегодня\n\nэто последний шанс присоединиться, чтобы начать менять свою фигуру 🍑👅",
               {
                  reply_markup: {
                     inline_keyboard: [
                        [
